<footer class="footer">
	<ul class="footer__links">
		...
		<li class="footer__links_item">
			<a href="/imprint" class="footer__links__item__link">Imprint</a>
		</li>
		<li class="footer__links_item">
			<a href="/privacy-policy" class="footer__links__item__link">Privacy Policy</a>
		</li>
		<li class="footer__links_item">
			<a href="/accessibility-statement" class="footer__links__item__link"
				>Accessibility Statement</a
			>
		</li>
		<li class="footer__links_item">
			<span class="footer__copy-right">© 2024 Accessibility.Cool</span>
		</li>
	</ul>
</footer>
